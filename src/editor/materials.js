...
const library = {
    ...
    digitStat: {
        ...
        style: {
            ...defaultStyle,
            background:
                "linear-gradient(180deg, rgba(10, 25, 46, 0.86), rgba(4, 10, 20, 0.82))",
        },
        props: {
            title: "今日交易额",
            value: 1284068,
    ...
    noticeTicker: {
        ...
        style: {
            ...defaultStyle,
            background:
                "linear-gradient(180deg, rgba(8, 21, 39, 0.9), rgba(4, 10, 20, 0.84))",
            radius: 20,
            padding: 12,
        },
        props: {
    ...
    tabPanel: {
        ...
        style: {
            ...defaultStyle,
            background:
                "linear-gradient(180deg, rgba(8, 20, 38, 0.92), rgba(4, 10, 20, 0.86))",
            padding: 18,
        },
        props: {
            title: "运行分区",
    ...
    filterBar: {
        ...
        style: {
            ...defaultStyle,
            background:
                "linear-gradient(180deg, rgba(8, 20, 38, 0.92), rgba(4, 10, 20, 0.84))",
            radius: 22,
            padding: 14,
        },
        props: {
    ...
    timelinePanel: {
        ...
        style: {
            ...defaultStyle,
            background:
                "linear-gradient(180deg, rgba(8, 20, 38, 0.94), rgba(4, 10, 20, 0.88))",
            padding: 18,
        },
        props: {
            title: "事件处理时间轴",
    ...
    panel: {
        ...
        style: {
            ...defaultStyle,
            background:
                "linear-gradient(180deg, rgba(17, 44, 82, 0.84), rgba(6, 14, 30, 0.84))",
        },
        props: {
            title: "业务分区",
            subtitle: "支持作为信息容器使用",
