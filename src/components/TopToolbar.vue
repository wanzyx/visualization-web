    ...
    <div class="toolbar__row toolbar__row--controls">
      ...
      <div class="toolbar__actions">
        <div class="toolbar__action-group">
          ...
          <button class="ghost" :disabled="!canCopy" @click="$emit('copy-selected')">复制</button>
          <button class="ghost" :disabled="!canPaste" @click="$emit('paste-selected')">粘贴</button>
          <button class="ghost" :disabled="!canOperate" @click="$emit('duplicate-selected')">克隆</button>
          <button class="ghost danger" :disabled="!canOperate" @click="$emit('delete-selected')">
            删除
          </button>
        </div>
        ...
        <div class="toolbar__action-group toolbar__action-group--highlight">
          <button class="ghost" @click="$emit('copy-runtime-link')">运行链接</button>
