    ...
    <aside class="side-panel side-panel--left">
        ...
        <section class="material-section">
            <div class="material-section__header">
                <div>
                    <h3>基础组件</h3>
                    <p class="material-section__caption">
                        适合快速搭建标题、图表、指标卡和装饰面板。
                    </p>
                </div>
            ...
            <div class="material-list">
                <button
                    ...
                    draggable="true"
                    @dragstart="
                        startDrag($event, { kind: 'material', type: item.type })
                    "
                ...
                >
                    ...
                    <span class="material-card__description">{{
                        item.description
                    }}</span>
                    <span class="material-card__hint"
                        >点击添加 / 拖拽到画布</span
                    >
                </button>
            </div>
        ...
        <section class="material-section">
            ...
            <div v-if="templates.length" class="material-list">
                ...
                >
                    ...
                    >
                        ...
                        <span class="material-card__label">{{
                            template.name
                        }}</span>
                        <span class="material-card__description">{{
                    ...
                    <button
                        class="template-card__remove"
                        @click="emit('remove-template', template.id)"
                    >
                        删除
                    </button>
                </div>
            ...
            <div v-else class="material-empty">
                <span
                    >选中画布上的组件后，点击顶部“保存模板”即可沉淀成可复用模板。</span
                >
            </div>
        </section>
        ...
        <div class="panel-tip panel-tip--accent">
            <p>工作流建议</p>
            <span
                >先搭页面结构，再绑定数据源，最后通过事件联动完成跳页和高亮交互。</span
            >
        </div>
    </aside>
</template>
