...
const visibleUndoEntries = computed(() => [...props.undoEntries].slice(-6).reverse())
const visibleRedoEntries = computed(() => [...props.redoEntries].slice(-6).reverse())
</script>
    ...
    <div class="history-panel__columns">
      <div class="history-panel__column">
        ...
        <div class="history-panel__list">
          ...
          <span v-if="!visibleUndoEntries.length" class="history-panel__empty">暂无</span>
        </div>
      </div>
      ...
      <div class="history-panel__column">
        ...
        <div class="history-panel__list">
          ...
          <span v-if="!visibleRedoEntries.length" class="history-panel__empty">暂无</span>
        </div>
      </div>
    </div>
  </section>
